    ...
    <div className="space-y-10">
      <div className="flex justify-between">
        <div className="flex gap-10">
          ...
          <div>
            <h1 className="text-5xl font-bold">제품 이름</h1>
            <p className="text-2xl font-light">제품 설명</p>
            <div className="mt-5 flex items-center gap-5">
              ...
              <span className="text-muted-foreground">100개의 리뷰</span>
            </div>
          </div>
        </div>
        <div className="flex gap-5">
          <Button variant="secondary" size="lg" className="text-xl h-14 px-10">
            Visit Website
          </Button>
